...
$(document).ready(function(){
   ...
   validate('.consultation-form1', {submitFunction:validationCall});
   validate('.consultation-form3', {submitFunction:validationCall});
   validate('.consultation-form2', {submitFunction:validationCall});
   Maskedinput();
   fancyboxForm();
